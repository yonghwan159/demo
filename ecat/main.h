...
/* main.h */
/****************************************************************************/
#include <embdECATM_demo.h> //./libs/ecatservo 
...
RTIME EcatPeriod, EcatExecution, EcatJitter;
#define SEC_DURATION	(600)
#define BUF_SIZE	(SEC_DURATION*FREQ_PERSEC(ECATCTRL_TASK_PERIOD)) //1 minute data for 1ms Cyclic 
RTIME iBufEcatDataCnt = 0;
...
#define SECNUM	(NANOSEC_PER_SEC/ECATCTRL_TASK_PERIOD)
/* ECAT_STAT:
